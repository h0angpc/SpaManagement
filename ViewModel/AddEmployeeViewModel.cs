    ...
    public class AddEmployeeViewModel:BaseViewModel, INotifyDataErrorInfo
    {
        ...
        public AddEmployeeViewModel()
        {
            ...
            AddEmployeeCommand = new RelayCommand<Window>((p) =>
            {
                ...
                var displaylist = DataProvider.Ins.DB.EMPLOYEEs.Where(x => x.EMP_DISPLAYNAME == Name && x.EMP_ADDRESS == Address && x.EMP_CCCD == CCCD && x.EMP_PHONE == Phone && x.EMP_ROLE == Role && x.EMP_SALARY == decimal.Parse(Salary));
